...
<asp:Content ID="Body" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Size="X-Large" Font-Underline="True" 
        ForeColor="#000000" Font-Bold="true" Text="Add Evidence"></asp:Label>
    <br />
    <br />
    <br />
...
&nbsp;
        <asp:FileUpload ID="FileUpload1" runat="server" BorderColor="#FF5050" CssClass="pressed" />
        <br />
        <br />
        <asp:Button ID="Button2" runat="server" Text="Upload" onclick="Button2_Click" BorderColor="#FF5050" CssClass="sidebar" />
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;<br />
    <br />
    <asp:Button ID="Button1" runat="server" CssClass="sidebar" Height="33px" 
        Text="Submit " Width="86px" onclick="Button1_Click" BorderColor="#3333FF" />
    <br />
    <br />
