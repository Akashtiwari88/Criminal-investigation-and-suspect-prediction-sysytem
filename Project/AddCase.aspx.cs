...
{
    SqlConnection con = new SqlConnection(@"Data Source=LAPTOP-T07HIPE5;Initial Catalog=Crime;Integrated Security=True");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (c == "OK")
        {
            ...
            mail.From = new MailAddress("tiwariak121@gmail.com");
            mail.To.Add(Label7.Text);
            mail.Subject = "New Case Added to your Profile";
            mail.Body = "You Have been assigned to a new case : '" + TextBox2.Text + "' Case ID : '" + TextBox1.Text + "' and Your Password is : '" + a + "' ";
            SmtpServer.Port = 587;
            SmtpServer.Credentials = new System.Net.NetworkCredential("tiwariak121@gmail.com", "momdad8850");
