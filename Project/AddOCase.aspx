...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Body" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Size="X-Large" Font-Underline="True" 
        ForeColor="#000000" Font-Bold="true" Text ="Add Officer to Case"></asp:Label>
    <br />
    <br />
    <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <br />
    <br />
    <asp:Button ID="Button1" runat="server" CssClass="sidebar" Height="35px" 
        Text="Submit" Width="80px" onclick="Button1_Click" BorderColor="#3333FF" />
&nbsp;
    <br />
    <br />
