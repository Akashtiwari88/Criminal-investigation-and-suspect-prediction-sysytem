...
( NAME = N'Crime', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Crime.mdf' , SIZE = 2048KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Crime_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Crime_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
SET ANSI_PADDING OFF
GO
/******INSERT [dbo].[Officer] ([ID], [Name], [Image], [Mobile], [Address], [Mail], [Post]) VALUES (N'1001', N'AKASH TIWARI', N'Image\1.jpg', N'8850285090', N'vihighar, Panvel', N'tiwariak121@gmail.com', N'Goregoan')
INSERT [dbo].[Officer] ([ID], [Name], [Image], [Mobile], [Address], [Mail], [Post]) VALUES (N'1002', N'SIDDHESH UPADHYAY', N'Image\Officer1.jpg', N'9076113214', N'gfsycrrhtgkhg', N'pqr@gmail.com', N'Mumbai')
 Table [dbo].[NCase]    Script Date: 04/07/2016 15:55:51 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
