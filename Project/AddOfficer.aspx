...
<asp:Content ID="Body" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Text="Add Officer" Font-Size="X-Large" 
        Font-Underline="True" Font-Bold="true" ForeColor="#000000"></asp:Label>
    <br />
    <br />
    <br />
...
&nbsp;
    <asp:Button ID="Button1" runat="server" Text="Upload" onclick="Button1_Click" 
            style="height: 26px" BorderColor="#FF5050" CssClass="sidebar" />
    <br />
    <br />
    <asp:Image ID="Image1" runat="server" Height="185px" Width="180px" />
    <br />
    <br />
    <asp:Button ID="Button2" runat="server" CssClass="sidebar" Height="34px" 
        Text="Submit" Width="86px" onclick="Button2_Click" BorderColor="#3333FF" />
    <br />
    <br />
